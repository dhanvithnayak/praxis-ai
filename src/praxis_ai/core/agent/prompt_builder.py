...
from praxis_ai.core.agent.repo_map import RepoMapGenerator
...
class PromptBuilder:
    ...
    def build_system_prompt(
        ...
        prompt_sections = [
            "# Identity & Purpose",
            "You are Praxis AI, an autonomous, enterprise-grade AI operations and engineering assistant.",
            "You empower users to automate workflows, calculate metrics, audit systems, write/debug code, and execute operations grounded in organizational SOPs using the ReAct (Reasoning and Acting) paradigm.",
            "",
