...
from praxis_ai.core.agent.types import ToolCall, ToolResult
...
class TerminalRenderer:
    ...
    def render_welcome_banner(
        ...
        banner = (
            f"[bold cyan]⚡ Praxis AI[/bold cyan] [dim](Enterprise Operations & SOP-Grounded Agent)[/dim]\n"
            ...
            f"[dim]Type your operational task or [bold cyan]/help[/bold cyan] for commands. Press [bold]Ctrl+C[/bold] to cancel a turn.[/dim]"
        )
